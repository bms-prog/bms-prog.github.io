...
The app is designed to track incoming emails matching a specified filter, with a set check interval. When such emails arrive, you will receive a notification and the widget will show the number of received emails.
